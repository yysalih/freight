...
class ShipmentInnerForTruckPostView extends ConsumerWidget {
  final String shipmentUid;
  const ShipmentInnerForTruckPostView({super.key, required this.shipmentUid});
