...
Widget truckCardWidget(String language, {required double width, required String truckName, required String description,
  required List<String> tags, required BuildContext context}) {
  return Padding(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(truckName, style: kTitleTextStyle.copyWith(color: kWhite),),
                        SizedBox(
                          width: width * .75,
                          child: Text(description, style: kCustomTextStyle.copyWith(color: kWhite, fontSize: 13.w),),
                        ),
                      ],
                    ),
                  ],
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: MaterialButton(
                onPressed: () {
                  Navigator.push(context, routeToView(const NewPostView()));
                },
                color: kBlueColor,
                child: Row(
                  children: [
